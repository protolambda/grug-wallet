<div align="center">
    ...
    <h1>Grug wallet chrome extension</h1>
    <h3>If you see JS here it's only because the browser forced us</h3>
</div>

This was originally from [Chrome Extesion v3 starter](https://github.com/SimGus/chrome-extension-v3-starter). It's original readme is below
